    ...
    <a class="navbar-brand" href="index.jsp"><span class="fa fa-cog"></span> Learn Programming</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="loginPage.jsp"><span class="fa fa-cog"></span> Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="registrationPage.jsp"><span class="fa fa-share-square-o"></span> Register</a>
                    </li>
                </ul>
